...
cap = cv2.VideoCapture("C:\\vscode\\Teknofest\\klasor11\\hsv.mp4") # webcamden görüntü almak için içini 0 yaparaız
...
while 1:
    _,frame = cap.read()
    # frame = cv2.flip (frame,1) # webcamden görüntü alırsak
